...
export const RESULTS: ResultQuiz[] = [
  {
    ...
    text: 'Você coloca o bem coletivo acima dos próprios interesses. Coragem, honestidade e empatia guiam suas decisões, inspirando outras pessoas a fazer o que é certo.',
  ...
  },
  {
    ...
    text: 'Você acredita que força só faz sentido quando usada para defender os mais vulneráveis. Age com equilíbrio, responsabilidade e espírito de equipe.',
  ...
  },
  {
    ...
    text: 'Nem sempre acredita que as regras sejam suficientes para fazer justiça. Prefere agir por conta própria, assumindo as consequências das suas escolhas.',
  ...
  },
  {
    ...
    text: 'Você toma decisões de forma prática e estratégica. Lealdade existe, mas precisa ser conquistada. Seu foco está em atingir os objetivos da maneira mais eficiente possível.',
  ...
  },
  {
    ...
    text: 'Você desafia regras, provoca conflitos e não se intimida diante das consequências. Para você, poder e liberdade caminham lado a lado.',
