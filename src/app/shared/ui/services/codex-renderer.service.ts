...
import { CodexDocumentType, CodexRecord } from '@shared/models/codex.model';
...
export class CodexRendererService {
  ...
  private readonly presets: Record<CodexDocumentType, CodexLayer[]> = {
    artifact: ['frame', 'ornaments', 'details', 'seals', 'final'],
    entity: ['frame', 'ornaments', 'final'],
    location: ['frame', 'details', 'final'],
    archive: ['frame', 'details', 'seals', 'final'],
    protocol: ['frame', 'details'],
    mission: ['frame', 'ornaments', 'details', 'final'],
    order: ['frame', 'ornaments', 'seals', 'final'],
    phenomenon: ['frame', 'details', 'final'],
    technology: ['frame', 'details', 'seals', 'final'],
    unknown: ['frame', 'final'],
  };
